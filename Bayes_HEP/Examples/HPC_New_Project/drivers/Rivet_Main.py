...
# Build analyses
subprocess.run(['bash', '/usr/local/share/Bayes_HEP/Design_Points/Rivet_Analyses/run_analysis.sh', ','.join(analyses_list), project_dir], check=True)
...
if failed_builds:
    ...
    sys.exit(1)  # Signal to bash that something failed
else:
